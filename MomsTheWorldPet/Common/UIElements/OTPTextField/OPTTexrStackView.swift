...
class OTPStackView: UIStackView {
    ...
    let textBackgroundColor = AppColor.lightGrayPrimary
    let activeFieldBorderColor = AppColor.purplePrimary
    ...
    private final func setupTextField(_ textField: OTPTextField){
        ...
        textField.heightAnchor.constraint(equalToConstant: 48.Vadapted).isActive = true
        textField.widthAnchor.constraint(equalToConstant: 48.Hadapted).isActive = true
        textField.backgroundColor = textBackgroundColor
        textField.textAlignment = .center
        textField.adjustsFontSizeToFitWidth = false
        textField.font = AppFonts.inter16Regular
